...
//our object implementation start here ****************************************

/*
We need to provide a free function callback as sqlite3 demands it, but the first parameter
can be used to carry a pointer to our object instance and pass the information from sqlite
on to our object
*/
...
void MyDB::Init(const std::string & _dbFileName) {
	assert(pDB == nullptr);
